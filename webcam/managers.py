...
class CaptureManager(object):
    ...
    def __init__(self, capture, previewWindowManager=None,
        ...
        self.previwWindowManager = previewWindowManager
    ...
    def enterFrame(self):
        assert not self._enteredFrame, \
               'previous enterframe(0 had no matching exitFrame()'
